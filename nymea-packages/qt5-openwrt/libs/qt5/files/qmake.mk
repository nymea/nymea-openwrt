...
# Author: Mirko Vogt <mirko-openwrt@nanl.de>, Simon Stürz <simon.stuerz@nymea.io>
...
QMAKE_TARGET=$(TOOLCHAIN_DIR)/bin/qmake

# Can be called optional with additional qmake parameters
# $(call Build/Configure/Default,CONFIG+=disabletesting)
...
define Build/Compile/Default
	...
	LDFLAGS="$(TARGET_LDFLAGS)" \
		$(MAKE) -j $((1+$(nproc))) -C $(PKG_BUILD_DIR)/$(MAKE_PATH) \
			$(1)
endef
